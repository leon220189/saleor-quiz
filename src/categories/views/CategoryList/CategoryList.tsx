...
export const CategoryList: React.FC<CategoryListProps> = ({ params }) => {
  ...
  const dataTest: RootCategoriesQuery = {
    "categories": {
      ...
      "edges": [
        {
          ...
          "node": {
            "__typename": "Category",
            "id": "Q2F0ZWdvcnk6MQ==01",
            "name": "Default Quiz 01",
            "children": {
              "__typename": "CategoryCountableConnection",
              "totalCount": 0
            },
        ...
        },
        {
          ...
          "node": {
            "__typename": "Category",
            "id": "Q2F0ZWdvcnk6MQ==02",
            "name": "Default Quiz 02",
            "children": {
              "__typename": "CategoryCountableConnection",
              "totalCount": 0
            },
      ...
      "pageInfo": {
        "__typename": "PageInfo",
        "endCursor": "WyJEZWZhdWx0IENhdGVnb3J5IiwgImRlZmF1bHQtY2F0ZWdvcnkiXQ==",
        "hasNextPage": false,
        "hasPreviousPage": false,
        "startCursor": "WyJEZWZhdWx0IENhdGVnb3J5IiwgImRlZmF1bHQtY2F0ZWdvcnkiXQ=="
      }
    },
    __typename: "Query"
  }
  const categories = mapEdgesToItems(dataTest?.categories);
  const paginationValues = usePaginator({
    pageInfo: dataTest?.categories?.pageInfo,
    paginationState,
    queryString: params,
  });
  ...
  return (
    <PaginatorContext.Provider value={paginationValues}>
      <CategoryListPage
        ...
        categories={mapEdgesToItems(dataTest?.categories)!}
